...
class RGBColorMixer
{
	...
	public Color Additive(Color aFirstColor, Color aSecondColor, float aIntensity)
	{
	    ...
	    result = LinearMix(LinearMix(aFirstColor, aSecondColor, aIntensity), Color.FromArgb(255, fR, fG, fB), cd);
	...
	{
	    return Color.FromArgb(255, 255 - input.R, 255 - input.G, 255 - input.B);
	}
